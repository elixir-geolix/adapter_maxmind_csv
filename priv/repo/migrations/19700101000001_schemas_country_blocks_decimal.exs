defmodule Geolix.Adapter.MaxMindCSV.Repo.Migrations.SchemasCountryBlocksDecimal do
  use Ecto.Migration

  def change do
    create table("geolix_maxmind_csv_country_blocks_decimal", primary_key: false) do
    ...
    create index(
             "geolix_maxmind_csv_country_blocks_decimal",
