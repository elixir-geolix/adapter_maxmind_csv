if Code.ensure_loaded?(EctoIPRange.IP4R) do
  defmodule Geolix.Adapter.MaxMindCSV.Schema.CityBlockIP4R do
    @moduledoc """
    Sample `Ecto.Schema` to use with the adapter for city databases (blocks).

    Table name: `geolix_maxmind_csv_city_blocks_ip4r`.
    ...
    schema "geolix_maxmind_csv_city_blocks_ip4r" do
